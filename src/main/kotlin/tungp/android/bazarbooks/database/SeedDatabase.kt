...
fun seedDatabase() {
    ...
    // Insert sample books
    val books = listOf(
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/13151170-L.jpg", "description" to "A heartwarming tale of adventure and self-discovery.", "isbn" to "978-1-000000001", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2015, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "The Bane Chronicles", "author" to "Maureen Johnson"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/12634691-L.jpg", "description" to "A thought-provoking exploration of human nature and society.", "isbn" to "978-1-000000002", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2007, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "Koralina", "author" to "Neil Gaiman"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/9171544-L.jpg", "description" to "A thrilling journey through time and space.", "isbn" to "978-1-000000003", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2020, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "Red, White & Royal Blue", "author" to "Casey McQuiston"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/12816871-L.jpg", "description" to "A classic masterpiece that continues to inspire generations.", "isbn" to "978-1-000000004", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2018, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "Twisted Lies", "author" to "Ana Huang"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/14407898-L.jpg", "description" to "Unravel the secrets within this gripping psychological thriller.", "isbn" to "978-1-000000005", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2022, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "Fourth Wing", "author" to "Rebecca Yarros"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/471953-L.jpg", "description" to "Experience a whirlwind of emotions in this poignant romance.", "isbn" to "978-1-000000006", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2005, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "Surrendered Single", "author" to "Laura Doyle"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/505653-M.jpg", "description" to "Discover ancient wisdom and modern insights in this insightful guide.", "isbn" to "978-1-000000007", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2010, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "The River Devil", "author" to "Diane Whiteside"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/10740111-L.jpg", "description" to "An enthralling read that will keep you on the edge of your seat.", "isbn" to "978-1-000000008", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2013, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "Fifty Shades of Grey", "author" to "E. L. James"),
        mapOf("coverUrl" to "https://covers.openlibrary.org/b/id/14416194-L.jpg", "description" to "A heartwarming tale of adventure and self-discovery.", "isbn" to "978-1-000000009", "numberOfPages" to 300, "price" to 15.00, "publishedYear" to 2017, "publisher" to "Unknown Publisher", "stock" to 10, "rating" to 4, "title" to "Court of Mist and Fury", "author" to "Sarah J. Maas")
    )
